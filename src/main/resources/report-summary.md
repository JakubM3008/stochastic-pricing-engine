...
- Format all monetary amounts (Expected Shortfall, Volatility, Utility) as standard USD currency (e.g., $12,191,028.74) rather than scientific notation or exponential numbers.
